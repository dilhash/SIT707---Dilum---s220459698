...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from s220459698, Dilum Balaarachchi");
	     ...
	     * Hint: Explore Selenium window functions to select one which allows passing window size in WxH.
	     */
	    // write code
